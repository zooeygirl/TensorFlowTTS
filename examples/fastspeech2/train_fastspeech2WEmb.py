...
class FastSpeech2Trainer(FastSpeechTrainer):
    ...
    def _train_step(self, batch):
        ...
        charactor, duration, f0, energy, mel, emb = batch
        self._one_step_fastspeech2(charactor, duration, f0, energy, mel, emb)
    ...
    def _eval_epoch(self):
        ...
        for eval_steps_per_epoch, batch in enumerate(
            ...
            # eval one step
            charactor, duration, f0, energy, mel, emb = batch
            self._eval_step(charactor, duration, f0, energy, mel, emb)
    ...
    def generate_and_save_intermediate_result(self, batch):
        ...
        masked_mel_before, masked_mel_after = self.predict(
            charactor, duration, f0, energy, mel, emb
        )
